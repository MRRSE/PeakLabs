...
//                             ${m.perms
//                               .map(
//                                 (p) => `<span class="permission">${p}</span>`,
//                               )
//                               .join("")}
//                         </div>
//                     </td>
...
//                     <td>
//                         <span class="status ${m.status === "online" ? "published" : "archived"}">
//                             ${m.status === "online" ? "آنلاین" : "آفلاین"}
//                         </span>
//                     </td>
...
//                             <button
//                                 class="action"
//                                 onclick="openModal('${id === "adminRows" ? "admin" : "developer"}')">
